...
export default function Chatbot() {
  ...
  return (
    ...
    >
      <div className="bg-[#005e54] text-white p-4 flex items-center gap-2 shadow-md fixed top-0 right-0 left-0 z-50">
        <img
      ...
      <div className="flex-1 p-4 space-y-2 overflow-y-auto flex flex-col mt-16">
